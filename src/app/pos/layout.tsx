...
export default function POSLayout({
  ...
  /* Fondo oscuro en body solo en área POS para que el canvas WebGL destaque (evita gris claro de bg-surface). */
  useEffect(() => {
    document.body.dataset.posShell = '1';
    return () => {
      delete document.body.dataset.posShell;
    };
  }, []);
        ...
        <>
          ...
          <div className="pos-layout relative z-[15] flex h-screen min-h-0 overflow-hidden bg-transparent">
            ...
            <main className="min-w-0 flex-1 flex flex-col overflow-auto">
              ...
              <AdminModeBanner />
              <div className="pos-main-inner min-h-full flex-1 px-4 py-5 sm:px-6 sm:py-6">
                {children}
              </div>
            </main>
          </div>
